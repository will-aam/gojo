...
import Aniversarios from "./Aniversarios"; // Importa o novo componente
...
type Aluno = {
  ...
  nome: string;
  modalidade: string;
  nascimento: string; // Formato "AAAA-MM-DD"
};
...
const alunos: Aluno[] = [
  ...
  },
  {
    ...
    nome: "Juliana Santos",
    modalidade: "Jiu-Jitsu",
    nascimento: "1997-11-05",
  },
  {
    id: 5,
    nome: "Fernando Lima",
    modalidade: "Muay Thai",
    nascimento: "2001-04-28",
  },
  {
    id: 6,
    nome: "Mariana Oliveira",
    modalidade: "Misto",
    nascimento: "1999-07-16",
  },
  {
    id: 7,
    nome: "Ricardo Gomes",
  ...
  { id: 8, nome: "Ana Beatriz", modalidade: "Misto", nascimento: "2003-09-01" },
];
...
export default function DashboardPage() {
  ...
  const handleNavClick = (view: "chamada" | "aniversarios" | "painel") => {
    // Adicione este console.log para depurar
    console.log("Mudando a visualização para:", view);
    setActiveView(view);
    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      >
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl font-bold text-blue-400">Dojo TC</h2>
          <button
            onClick={() => setIsMenuOpen(false)}
        ...
        <nav className="flex flex-col space-y-4">
          <button
            onClick={() => handleNavClick("painel")}
            className="text-lg text-left text-gray-300 hover:text-blue-400 transition-colors"
          >
            Painel
          </button>
          <button
            onClick={() => handleNavClick("chamada")}
            className="text-lg text-left text-gray-300 hover:text-blue-400 transition-colors"
          >
            Lista de Chamada
          </button>
          <button
            onClick={() => handleNavClick("aniversarios")}
            className="text-lg text-left text-gray-300 hover:text-blue-400 transition-colors"
          >
            Aniversários
          </button>
      ...
      <header className="flex items-center bg-gray-800 p-4 shadow-md">
        ...
        <div className="text-2xl font-bold text-blue-400">Dojo TC</div>
      </header>

      {/* --- CONTEÚDO PRINCIPAL DA PÁGINA --- */}
      <main className="flex-1 p-6 md:p-8">
        {/* Renderização Condicional do Conteúdo */}
        {activeView === "aniversarios" && <Aniversarios alunos={alunos} />}

        {(activeView === "chamada" || activeView === "painel") && (
          <>
